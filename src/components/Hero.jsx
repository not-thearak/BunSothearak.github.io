        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              I'm a software development student passionate about building web
              and mobile applications, eager to apply my skills in a hands-on
              internship. I enjoy tackling new technical challenges, learning
              fast, and contributing to real-world projects as I grow into a
